...
export class ChildService {
    ...
    insertchild( firstName: string, lastName: string, parentId: string,):
    string {
    ...
    updateChild(firstName: string, lastName: string, parentId: string,):
    Child {
        const [child, index] = this.findChild(child);
        if(firstName) {
